...
- **NFR-010 Backup and recovery** — Backup frequency/retention: to be confirmed. MongoDB holds the mailbox and audit trail; Query Cases are still browser-local and have no backup story at all.
