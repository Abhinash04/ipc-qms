...
const queryCaseSchema = new mongoose.Schema(
  {
     ...
     * incoming email opens one case. Null on a case that did not come from a
     * mailbox message — seeded data, and cases from before the field existed.
     */
     ...
     * mailbox. Null on cases from before it existed, which use the configured
     * EMAIL_TRANSPORT as they always did.
     */
 ...
 * unique index would collide every case without one on that null — the same
