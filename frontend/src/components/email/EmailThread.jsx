    ...
    >
      ...
      >
        <div className="flex flex-wrap items-center gap-2.5 mb-4 pb-3 border-b border-slate-100/60">
          ...
          <span
            className={cn(
              "ml-auto text-[13.5px] font-bold tracking-wide uppercase",
        ...
        <div
          className={cn(
            "text-[15px] space-y-2 mb-4 p-3.5 rounded-2xl border",
            inbound
        ...
        >
          <div className="flex gap-3 items-start">
            <span
              className={cn(
                "font-extrabold shrink-0 w-11 text-right",
                inbound ? "text-slate-400" : "text-blue-400",
              )}
            >
              From
        ...
        <h3 className="text-[18px] font-black text-slate-900 mb-2 leading-snug">
          {message.subject}
        </h3>
