...
const IPC_ANNOUNCEMENTS = [
  {
    ...
    summary: 'Draft addendum containing 48 new API & formulation monographs is open for stakeholder feedback.',
    date: '2026-08-25',
    priority: 'high',
    icon: FileText,
  ...
  },
  {
    ...
    title: 'Strict 24-Hour SLA Mandatory for High Priority (P1) Technical Queries',
    titleHi: 'उच्च प्राथमिकता (P1) प्रश्नों हेतु 24 घंटे की एसएलए अनिवार्य',
    summary: 'All P1 queries submitted via IPC-QMS must be acknowledged, assigned, and verified within 24 hours.',
    date: '2026-08-26',
    priority: 'high',
    icon: Zap,
  ...
  },
  {
    ...
    summary: 'National Pharmacopoeia Laboratory (NPL) has published new reference standard batches for active drug ingredients.',
    date: '2026-08-24',
    priority: 'medium',
    icon: FlaskConical,
  ...
  },
  {
    ...
    summary: 'Ministry of Health & Family Welfare directs all drug manufacturers to submit official technical queries online.',
    date: '2026-08-22',
    priority: 'high',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    summary: 'Division heads and reviewers are urged to process pending reviews promptly to maintain 98%+ SLA compliance.',
    date: '2026-08-20',
    priority: 'medium',
    icon: Gauge,
  ...
  },
  {
    ...
    summary: 'Annual quality assurance audit for IPC laboratories scheduled from 15th to 20th September 2026.',
    date: '2026-08-18',
    priority: 'info',
    icon: Clock,
...
export function ScrollingMarquee({ className = '' }) {
  ...
  // Duplicating items for seamless infinite scroll loop
  const marqueeItems = [...IPC_ANNOUNCEMENTS, ...IPC_ANNOUNCEMENTS];

  return (
    <div className={`px-5 lg:px-7 mb-3 select-none ${className}`}>
      {/* Main Glass Marquee Bar */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-white/95 via-slate-50/90 to-indigo-50/85 backdrop-blur-xl border border-white/90 shadow-[0_4px_20px_rgba(37,99,235,0.06)] group">
        
        {/* Top Glow Accent Line */}
        <div className="h-0.5 w-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 opacity-80" />

        <div className="flex items-center min-h-[46px] py-1.5 px-3">
          
          {/* Scrolling Marquee Container */}
          <div className="relative flex-1 overflow-hidden py-1">
            {/* Edge Fades */}
            <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-white/95 to-transparent z-10" />
            <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-indigo-50/95 to-transparent z-10" />
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-slate-400 text-xs hidden md:inline font-medium">
                      — {item.summary.length > 55 ? item.summary.slice(0, 55) + '...' : item.summary}
                    </span>
            ...
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-100">
                  {React.createElement(selectedAnnouncement.icon, { className: 'h-5 w-5' })}
                </span>
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {selectedAnnouncement.category} ({selectedAnnouncement.categoryHi})
                    </span>
            ...
            <div className="py-5 space-y-4">
              <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100">
                <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                  <Info className="h-3.5 w-3.5 text-indigo-500" /> Executive Summary / विवरणी
                </h4>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 rounded-xl bg-indigo-50/50 border border-indigo-100/60">
                  ...
                  <span className="font-extrabold text-slate-800">{selectedAnnouncement.date}</span>
                </div>
                <div className="p-3 rounded-xl bg-purple-50/50 border border-purple-100/60">
                  <span className="text-slate-400 font-semibold block mb-0.5">Authority</span>
                  <span className="font-extrabold text-slate-800">IPC MoHFW, Govt of India</span>
                </div>
              </div>
            </div>
