...
export function StatTile({
  ...
  const badgeGradients = {
    assigned:
      "bg-[linear-gradient(135deg,#3478F6,#173B9C)] shadow-[0_12px_20px_rgba(52,120,246,0.28)]",
    drafting:
      "bg-[linear-gradient(135deg,#F59E0B,#EA580C)] shadow-[0_12px_20px_rgba(245,158,11,0.26)]",
    review:
      "bg-[linear-gradient(135deg,#FB7185,#E11D48)] shadow-[0_12px_20px_rgba(244,63,94,0.24)]",
    closed:
      "bg-[linear-gradient(135deg,#34D399,#059669)] shadow-[0_12px_20px_rgba(16,185,129,0.24)]",
  };

  const currentBadgeGrad =
    badgeGradients[illustrationType] || badgeGradients.assigned;
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            cardBg ||
            "linear-gradient(180deg, rgba(255,255,255,0.85) 0%, rgba(247,250,255,0.78) 100%)",
        }}
      />
          ...
          {trendText && (
            <span
              className={cn(
                ...
                trendType === "down" ? "text-rose-600" : "text-emerald-600",
              )}
            >
              {trendText}
            </span>
        ...
        <div className="flex items-end justify-between mt-6 z-10">
          <div className="flex flex-col justify-end">
            ...
            <div className="mt-2.5 space-y-0.5">
              <div
                className={cn(
                  "text-[12px] font-black flex items-center gap-1",
