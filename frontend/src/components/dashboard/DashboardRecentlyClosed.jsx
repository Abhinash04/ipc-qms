          ...
          <div className="my-4 rounded-2xl border border-dashed border-emerald-200/80 bg-[#f8fcf9] p-8 flex flex-col items-center justify-center text-center">
            <div className="relative w-44 h-32 flex items-center justify-center select-none pointer-events-none mb-2">
              ...
              >
                ...
                />
                <path
                  d="M30 65 L80 90 L130 65 V100 C130 105 125 110 120 110 H40 C35 110 30 105 30 100 V65 Z"
                  fill="#10b981"
                />
                <path
                  d="M30 65 L80 95 L130 65 L80 90 L30 65 Z"
                  fill="#059669"
                />
                <circle cx="115" cy="85" r="16" fill="#ffffff" />
                <circle cx="115" cy="85" r="14" fill="#34d399" />
                <path
                  d="M109 85 L113 89 L121 81"
                  stroke="#ffffff"
                  strokeWidth="3"
                  strokeLinecap="round"
            ...
            <div className="text-[16px] font-extrabold text-slate-900 mt-2">
              Nothing closed yet
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 overflow-hidden">
                  <div className="text-[13.5px] font-bold text-slate-800 truncate">
                    {item.subject}
                  </div>
